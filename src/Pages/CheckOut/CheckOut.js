...
const CheckOut = () => {
    const {title, category_id, _id, price, course_modules, image_url, details} = useLoaderData();
    ...
    return (
        <div className="flex justify-center items-center">
            <div className="pt-4 pb-8 px-4 md:px-6 2xl:px-0 flex justify-center items-center 2xl:mx-auto 2xl:container">
                    ...
                    <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
                        <div className="xl:w-3/5 flex flex-col sm:flex-row xl:flex-col justify-center items-center bg-gray-100 py-7 sm:py-0 xl:py-10 px-10 xl:w-full">
                            <div className="flex flex-col justify-start items-start w-full space-y-4">
                                ...
                                <p className="text-base font-semibold leading-none text-gray-600">${price.number}</p>
                            </div>
                            <div className="mt-6 sm:mt-0 xl:my-10 xl:px-20 w-52 sm:w-96 xl:w-auto">
                                <img className="rounded-xl" src={image_url} alt="headphones" />
                            </div>
                        </div>
                        ...
                        <div className="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
                            ...
                            <button className="mt-8 border border-transparent hover:border-gray-300 bg-gray-900 hover:bg-white text-white hover:text-gray-900 flex justify-center items-center py-4 rounded w-full">
                                <div>
                                    <p className="text-base leading-4">Pay: ${price.number}</p>
                                </div>
                            </button>
                        </div>
                    </div>
