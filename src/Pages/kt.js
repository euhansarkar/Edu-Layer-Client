  ...
  <div className="p-6 space-y-8">
    <header className="container flex items-center justify-between h-16 px-4 mx-auto rounded dark:bg-gray-900">
      ...
      <div className="items-center hidden space-x-8 lg:flex">
        ...
        <button className="px-4 py-2 rounded-md dark:bg-blue-400 dark:text-gray-900">
          Sign up
        </button>
      </div>
      ...
      <div className="container mx-auto space-y-16">
        <section className="grid gap-6 text-center lg:grid-cols-2 xl:grid-cols-5">
          <div className="w-full p-6 rounded-md sm:p-16 xl:col-span-2 dark:bg-gray-900">
            <span className="block mb-2 dark:text-blue-400">
              Mamba design system
            </span>
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md focus:ring focus:ring-blue-400 dark:border-gray-700"
                />
              </div>
              <div>
              ...
              <button className="w-full py-2 font-semibold rounded dark:bg-blue-400 dark:text-gray-900">
                Join the waitlist
              </button>
            </form>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="overflow-hidden rounded lg:flex lg:col-span-3">
              ...
              <div className="p-6 space-y-6 lg:p-8 md:flex md:flex-col dark:bg-gray-900">
                <span className="self-start px-3 py-1 text-sm rounded-full dark:bg-blue-400 dark:text-gray-900">
                  Business
                </span>
